...
public class Tile
{
	...
	public GameObject forwardCover;
	public GameObject backCover;
	public List<GameObject> listOfActiveCover;
	...
	public Tile(Node node, Transform parent, List<Tile> listTiles)
	{
		...
		listTiles.Add(this);
		node.tile = this;
		listOfActiveCover = new List<GameObject>();
	}
	...
	public void destroyAllActiveCover()
	{
		...
		foreach (GameObject cover in listOfActiveCover)
		{
